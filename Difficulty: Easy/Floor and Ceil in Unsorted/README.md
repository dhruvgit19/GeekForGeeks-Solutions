<h2><a href="https://www.geeksforgeeks.org/problems/ceil-the-floor2802/1?utm_medium=collab_striver_ytdescription&utm_campaign=ceil-the-floor&utm_source=youtube">Floor and Ceil in Unsorted</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p style="text-align: left;"><span style="font-size: 18px;">Given an unsorted array <strong>arr[]</strong> of integers and an integer <strong>x</strong>, find the floor and ceiling of <strong>x</strong> in <strong>arr[]</strong>.</span></p>
<ul>
